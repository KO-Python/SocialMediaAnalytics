...
date_range = st.date_input("2. 시작과 끝 날짜를 선택해 주세요",
                           value=[datetime.date(2023, 1, 10), datetime.date(2023, 2, 1)],
                           min_value=datetime.date(2023, 1, 5),
                           max_value=datetime.date(2023, 2, 20))
st.write("당신이 선택한 날짜의 범위: ", date_range)

#streamlit run 11.StreamlitApp_14.py