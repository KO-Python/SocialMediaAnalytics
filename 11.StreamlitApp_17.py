...
image_files = ['11.StreamlitApp_Vermeer.png', '11.StreamlitApp_Gogh.png',
               '11.StreamlitApp_Munch.png', '11.StreamlitApp_ShinYoonbok.png'] # 이미지 파일 리스트
...
#streamlit run 11.StreamlitApp_17.py